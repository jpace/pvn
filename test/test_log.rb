  ...
  class TestLog < Test::Unit::TestCase
    ...
    if false
      ...
      def test_command_using_negative_revision
        ...
        assert_log_command "svn log -l 5 -r 1199931", %w{ -r -1 }
        assert_log_command "svn log -l 10 -r 1199922", %w{ -l 10 -r -3 }
        assert_log_command "svn log -l 10 -r 1153485", %w{ -l 10 -r -17 }
      end
    else
